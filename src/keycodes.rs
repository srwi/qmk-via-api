...
/// Category grouping for QMK keycodes in key pickers and configuration tools.
#[cfg_attr(feature = "python", pyclass(from_py_object, eq, eq_int))]
...
impl KeycodeCategory {
    pub const ALL: [KeycodeCategory; 8] = [
        KeycodeCategory::Basic,
        KeycodeCategory::Media,
        KeycodeCategory::Special,
        KeycodeCategory::Backlight,
        KeycodeCategory::Rgblight,
        KeycodeCategory::RgbMatrix,
        KeycodeCategory::Audio,
...
impl KeycodeCategory {
    /// Returns all static candidate keycodes belonging to this category.
    pub fn keycodes(&self) -> &'static [Keycode] {
        Keycode::all_in_category(*self)
    }
}

#[cfg_attr(feature = "python", pymethods)]
impl Keycode {
    /// Returns the `KeycodeCategory` this keycode belongs to.
    pub const fn category(&self) -> KeycodeCategory {
        match *self as u16 {
            0x00A8..=0x00C2 => KeycodeCategory::Media,
            0x7800..=0x7806 => KeycodeCategory::Backlight,
            0x7820..=0x7834 => KeycodeCategory::Rgblight,
            0x7810..=0x7818 | 0x7840..=0x784C => KeycodeCategory::RgbMatrix,
            0x7100..=0x718F | 0x7200..=0x7208 | 0x7480..=0x7495 => KeycodeCategory::Audio,
            0x7700..=0x771F | 0x7E00..=0x7E1F | 0x7E40..=0x7E5F => KeycodeCategory::Custom,
            0x56F0..=0x56F6
            | 0x7000..=0x7022
            | 0x7400..=0x741F
            | 0x7440..=0x745F
            | 0x74F0..=0x74FC
            | 0x7C00..=0x7C7A => KeycodeCategory::Special,
            _ => KeycodeCategory::Basic,
        }
    }

    /// Encodes this `Keycode` into its 16-bit numeric value.
...
impl Keycode {
    /// Returns the static slice of keycodes belonging to the specified category.
    pub fn all_in_category(category: KeycodeCategory) -> &'static [Keycode] {
        match category {
            KeycodeCategory::Basic => BASIC_KEYCODES,
            KeycodeCategory::Media => MEDIA_KEYCODES,
            KeycodeCategory::Special => SPECIAL_KEYCODES,
            KeycodeCategory::Backlight => BACKLIGHT_KEYCODES,
            KeycodeCategory::Rgblight => RGBLIGHT_KEYCODES,
            KeycodeCategory::RgbMatrix => RGB_MATRIX_KEYCODES,
            KeycodeCategory::Audio => AUDIO_KEYCODES,
            KeycodeCategory::Custom => CUSTOM_KEYCODES,
        }
    }

    /// Decodes a 16-bit integer into a recognized `Keycode`, if valid.
...
#[pymethods]
impl KeycodeCategory {
    /// Returns all static candidate keycodes belonging to this category as a Python list.
    #[pyo3(name = "keycodes")]
    pub fn py_keycodes(&self) -> Vec<Keycode> {
        self.keycodes().to_vec()
    }

    /// Returns a list of all keycode categories.
    #[staticmethod]
    pub fn all() -> Vec<KeycodeCategory> {
        Self::ALL.to_vec()
    }
...
#[pymethods]
impl Keycode {
    /// Returns all keycodes belonging to a category as a Python list.
    #[staticmethod]
    #[pyo3(name = "all_in_category")]
    pub fn py_all_in_category(category: KeycodeCategory) -> Vec<Keycode> {
        Keycode::all_in_category(category).to_vec()
    }

    /// Decodes a 16-bit integer into a recognized `Keycode`, if valid.
    #[staticmethod]
    #[pyo3(name = "from_u16")]
    pub fn py_from_u16(code: u16) -> Option<Self> {
        Self::from_u16(code)
    }
}

pub static BASIC_KEYCODES: &[Keycode] = &[
    Keycode::KC_NO,
    ...
    Keycode::QK_MOUSE_BUTTON_1,
    Keycode::QK_MOUSE_BUTTON_2,
    Keycode::QK_MOUSE_BUTTON_3,
    ...
    Keycode::QK_MOUSE_ACCELERATION_0,
    Keycode::QK_MOUSE_ACCELERATION_1,
...
pub static MEDIA_KEYCODES: &[Keycode] = &[
...
pub static SPECIAL_KEYCODES: &[Keycode] = &[
    Keycode::QK_SWAP_HANDS_TOGGLE,
    Keycode::QK_SWAP_HANDS_TAP_TOGGLE,
    Keycode::QK_SWAP_HANDS_MOMENTARY_ON,
    Keycode::QK_SWAP_HANDS_MOMENTARY_OFF,
    Keycode::QK_SWAP_HANDS_OFF,
    Keycode::QK_SWAP_HANDS_ON,
    Keycode::QK_SWAP_HANDS_ONE_SHOT,
    Keycode::QK_MAGIC_SWAP_CONTROL_CAPS_LOCK,
    Keycode::QK_MAGIC_UNSWAP_CONTROL_CAPS_LOCK,
    Keycode::QK_MAGIC_TOGGLE_CONTROL_CAPS_LOCK,
    Keycode::QK_MAGIC_CAPS_LOCK_AS_CONTROL_OFF,
    Keycode::QK_MAGIC_CAPS_LOCK_AS_CONTROL_ON,
    Keycode::QK_MAGIC_SWAP_LALT_LGUI,
    Keycode::QK_MAGIC_UNSWAP_LALT_LGUI,
    Keycode::QK_MAGIC_SWAP_RALT_RGUI,
    Keycode::QK_MAGIC_UNSWAP_RALT_RGUI,
    Keycode::QK_MAGIC_GUI_ON,
    Keycode::QK_MAGIC_GUI_OFF,
    Keycode::QK_MAGIC_TOGGLE_GUI,
    Keycode::QK_MAGIC_SWAP_GRAVE_ESC,
    Keycode::QK_MAGIC_UNSWAP_GRAVE_ESC,
    Keycode::QK_MAGIC_SWAP_BACKSLASH_BACKSPACE,
    Keycode::QK_MAGIC_UNSWAP_BACKSLASH_BACKSPACE,
    Keycode::QK_MAGIC_TOGGLE_BACKSLASH_BACKSPACE,
    Keycode::QK_MAGIC_NKRO_ON,
    Keycode::QK_MAGIC_NKRO_OFF,
    Keycode::QK_MAGIC_TOGGLE_NKRO,
    Keycode::QK_MAGIC_SWAP_ALT_GUI,
    Keycode::QK_MAGIC_UNSWAP_ALT_GUI,
    Keycode::QK_MAGIC_TOGGLE_ALT_GUI,
    Keycode::QK_MAGIC_SWAP_LCTL_LGUI,
    Keycode::QK_MAGIC_UNSWAP_LCTL_LGUI,
    Keycode::QK_MAGIC_SWAP_RCTL_RGUI,
    Keycode::QK_MAGIC_UNSWAP_RCTL_RGUI,
    Keycode::QK_MAGIC_SWAP_CTL_GUI,
    Keycode::QK_MAGIC_UNSWAP_CTL_GUI,
    Keycode::QK_MAGIC_TOGGLE_CTL_GUI,
    Keycode::QK_MAGIC_EE_HANDS_LEFT,
    Keycode::QK_MAGIC_EE_HANDS_RIGHT,
    Keycode::QK_MAGIC_SWAP_ESCAPE_CAPS_LOCK,
    Keycode::QK_MAGIC_UNSWAP_ESCAPE_CAPS_LOCK,
    Keycode::QK_MAGIC_TOGGLE_ESCAPE_CAPS_LOCK,
    Keycode::QK_JOYSTICK_BUTTON_0,
    Keycode::QK_JOYSTICK_BUTTON_1,
    Keycode::QK_JOYSTICK_BUTTON_2,
    Keycode::QK_JOYSTICK_BUTTON_3,
    Keycode::QK_JOYSTICK_BUTTON_4,
    Keycode::QK_JOYSTICK_BUTTON_5,
    Keycode::QK_JOYSTICK_BUTTON_6,
    Keycode::QK_JOYSTICK_BUTTON_7,
    Keycode::QK_JOYSTICK_BUTTON_8,
    Keycode::QK_JOYSTICK_BUTTON_9,
    Keycode::QK_JOYSTICK_BUTTON_10,
    Keycode::QK_JOYSTICK_BUTTON_11,
    Keycode::QK_JOYSTICK_BUTTON_12,
    Keycode::QK_JOYSTICK_BUTTON_13,
    Keycode::QK_JOYSTICK_BUTTON_14,
    Keycode::QK_JOYSTICK_BUTTON_15,
    Keycode::QK_JOYSTICK_BUTTON_16,
    Keycode::QK_JOYSTICK_BUTTON_17,
    Keycode::QK_JOYSTICK_BUTTON_18,
    Keycode::QK_JOYSTICK_BUTTON_19,
    Keycode::QK_JOYSTICK_BUTTON_20,
    Keycode::QK_JOYSTICK_BUTTON_21,
    Keycode::QK_JOYSTICK_BUTTON_22,
    Keycode::QK_JOYSTICK_BUTTON_23,
    Keycode::QK_JOYSTICK_BUTTON_24,
    Keycode::QK_JOYSTICK_BUTTON_25,
    Keycode::QK_JOYSTICK_BUTTON_26,
    Keycode::QK_JOYSTICK_BUTTON_27,
    Keycode::QK_JOYSTICK_BUTTON_28,
    Keycode::QK_JOYSTICK_BUTTON_29,
    Keycode::QK_JOYSTICK_BUTTON_30,
    Keycode::QK_JOYSTICK_BUTTON_31,
    Keycode::QK_PROGRAMMABLE_BUTTON_1,
    Keycode::QK_PROGRAMMABLE_BUTTON_2,
    Keycode::QK_PROGRAMMABLE_BUTTON_3,
    Keycode::QK_PROGRAMMABLE_BUTTON_4,
    Keycode::QK_PROGRAMMABLE_BUTTON_5,
    Keycode::QK_PROGRAMMABLE_BUTTON_6,
    Keycode::QK_PROGRAMMABLE_BUTTON_7,
    Keycode::QK_PROGRAMMABLE_BUTTON_8,
    Keycode::QK_PROGRAMMABLE_BUTTON_9,
    Keycode::QK_PROGRAMMABLE_BUTTON_10,
    Keycode::QK_PROGRAMMABLE_BUTTON_11,
    Keycode::QK_PROGRAMMABLE_BUTTON_12,
    Keycode::QK_PROGRAMMABLE_BUTTON_13,
    Keycode::QK_PROGRAMMABLE_BUTTON_14,
    Keycode::QK_PROGRAMMABLE_BUTTON_15,
    Keycode::QK_PROGRAMMABLE_BUTTON_16,
    Keycode::QK_PROGRAMMABLE_BUTTON_17,
    Keycode::QK_PROGRAMMABLE_BUTTON_18,
    Keycode::QK_PROGRAMMABLE_BUTTON_19,
    Keycode::QK_PROGRAMMABLE_BUTTON_20,
    Keycode::QK_PROGRAMMABLE_BUTTON_21,
    Keycode::QK_PROGRAMMABLE_BUTTON_22,
    Keycode::QK_PROGRAMMABLE_BUTTON_23,
    Keycode::QK_PROGRAMMABLE_BUTTON_24,
    Keycode::QK_PROGRAMMABLE_BUTTON_25,
    Keycode::QK_PROGRAMMABLE_BUTTON_26,
    Keycode::QK_PROGRAMMABLE_BUTTON_27,
    Keycode::QK_PROGRAMMABLE_BUTTON_28,
    Keycode::QK_PROGRAMMABLE_BUTTON_29,
    Keycode::QK_PROGRAMMABLE_BUTTON_30,
    Keycode::QK_PROGRAMMABLE_BUTTON_31,
    Keycode::QK_PROGRAMMABLE_BUTTON_32,
    Keycode::QK_STENO_BOLT,
    Keycode::QK_STENO_GEMINI,
    Keycode::QK_STENO_COMB,
    Keycode::QK_STENO_COMB_MAX,
    Keycode::QK_BOOTLOADER,
    Keycode::QK_REBOOT,
    Keycode::QK_DEBUG_TOGGLE,
    Keycode::QK_CLEAR_EEPROM,
    Keycode::QK_MAKE,
    Keycode::QK_AUTO_SHIFT_DOWN,
    Keycode::QK_AUTO_SHIFT_UP,
    Keycode::QK_AUTO_SHIFT_REPORT,
    Keycode::QK_AUTO_SHIFT_ON,
    Keycode::QK_AUTO_SHIFT_OFF,
    Keycode::QK_AUTO_SHIFT_TOGGLE,
    Keycode::QK_GRAVE_ESCAPE,
    Keycode::QK_VELOCIKEY_TOGGLE,
    Keycode::QK_SPACE_CADET_LEFT_CTRL_PARENTHESIS_OPEN,
    Keycode::QK_SPACE_CADET_RIGHT_CTRL_PARENTHESIS_CLOSE,
    Keycode::QK_SPACE_CADET_LEFT_SHIFT_PARENTHESIS_OPEN,
    Keycode::QK_SPACE_CADET_RIGHT_SHIFT_PARENTHESIS_CLOSE,
    Keycode::QK_SPACE_CADET_LEFT_ALT_PARENTHESIS_OPEN,
    Keycode::QK_SPACE_CADET_RIGHT_ALT_PARENTHESIS_CLOSE,
    Keycode::QK_SPACE_CADET_RIGHT_SHIFT_ENTER,
    Keycode::QK_OUTPUT_AUTO,
    Keycode::QK_OUTPUT_USB,
    Keycode::QK_OUTPUT_BLUETOOTH,
    Keycode::QK_UNICODE_MODE_NEXT,
    Keycode::QK_UNICODE_MODE_PREVIOUS,
    Keycode::QK_UNICODE_MODE_MACOS,
    Keycode::QK_UNICODE_MODE_LINUX,
    Keycode::QK_UNICODE_MODE_WINDOWS,
    Keycode::QK_UNICODE_MODE_BSD,
    Keycode::QK_UNICODE_MODE_WINCOMPOSE,
    Keycode::QK_UNICODE_MODE_EMACS,
    Keycode::QK_HAPTIC_ON,
    Keycode::QK_HAPTIC_OFF,
    Keycode::QK_HAPTIC_TOGGLE,
    Keycode::QK_HAPTIC_RESET,
    Keycode::QK_HAPTIC_FEEDBACK_TOGGLE,
    Keycode::QK_HAPTIC_BUZZ_TOGGLE,
    Keycode::QK_HAPTIC_MODE_NEXT,
    Keycode::QK_HAPTIC_MODE_PREVIOUS,
    Keycode::QK_HAPTIC_CONTINUOUS_TOGGLE,
    Keycode::QK_HAPTIC_CONTINUOUS_UP,
    Keycode::QK_HAPTIC_CONTINUOUS_DOWN,
    Keycode::QK_HAPTIC_DWELL_UP,
    Keycode::QK_HAPTIC_DWELL_DOWN,
    Keycode::QK_COMBO_ON,
    Keycode::QK_COMBO_OFF,
    Keycode::QK_COMBO_TOGGLE,
    Keycode::QK_DYNAMIC_MACRO_RECORD_START_1,
    Keycode::QK_DYNAMIC_MACRO_RECORD_START_2,
    Keycode::QK_DYNAMIC_MACRO_RECORD_STOP,
    Keycode::QK_DYNAMIC_MACRO_PLAY_1,
    Keycode::QK_DYNAMIC_MACRO_PLAY_2,
    Keycode::QK_LEADER,
    Keycode::QK_LOCK,
    Keycode::QK_ONE_SHOT_ON,
    Keycode::QK_ONE_SHOT_OFF,
    Keycode::QK_ONE_SHOT_TOGGLE,
    Keycode::QK_KEY_OVERRIDE_TOGGLE,
    Keycode::QK_KEY_OVERRIDE_ON,
    Keycode::QK_KEY_OVERRIDE_OFF,
    Keycode::QK_SECURE_LOCK,
    Keycode::QK_SECURE_UNLOCK,
    Keycode::QK_SECURE_TOGGLE,
    Keycode::QK_SECURE_REQUEST,
    Keycode::QK_DYNAMIC_TAPPING_TERM_PRINT,
    Keycode::QK_DYNAMIC_TAPPING_TERM_UP,
    Keycode::QK_DYNAMIC_TAPPING_TERM_DOWN,
    Keycode::QK_CAPS_WORD_TOGGLE,
    Keycode::QK_AUTOCORRECT_ON,
    Keycode::QK_AUTOCORRECT_OFF,
    Keycode::QK_AUTOCORRECT_TOGGLE,
    Keycode::QK_TRI_LAYER_LOWER,
    Keycode::QK_TRI_LAYER_UPPER,
    Keycode::QK_REPEAT_KEY,
    Keycode::QK_ALT_REPEAT_KEY,
];

pub static BACKLIGHT_KEYCODES: &[Keycode] = &[
    Keycode::QK_BACKLIGHT_ON,
    Keycode::QK_BACKLIGHT_OFF,
    Keycode::QK_BACKLIGHT_TOGGLE,
    Keycode::QK_BACKLIGHT_DOWN,
    Keycode::QK_BACKLIGHT_UP,
    Keycode::QK_BACKLIGHT_STEP,
    Keycode::QK_BACKLIGHT_TOGGLE_BREATHING,
];

pub static RGBLIGHT_KEYCODES: &[Keycode] = &[
    ...
    Keycode::RGB_MODE_PLAIN,
    Keycode::RGB_MODE_BREATHE,
    Keycode::RGB_MODE_RAINBOW,
    Keycode::RGB_MODE_SWIRL,
    Keycode::RGB_MODE_SNAKE,
    Keycode::RGB_MODE_KNIGHT,
    Keycode::RGB_MODE_XMAS,
    Keycode::RGB_MODE_GRADIENT,
    Keycode::RGB_MODE_RGBTEST,
    Keycode::RGB_MODE_TWINKLE,
];

pub static RGB_MATRIX_KEYCODES: &[Keycode] = &[
    Keycode::QK_LED_MATRIX_ON,
    Keycode::QK_LED_MATRIX_OFF,
    Keycode::QK_LED_MATRIX_TOGGLE,
    Keycode::QK_LED_MATRIX_MODE_NEXT,
    Keycode::QK_LED_MATRIX_MODE_PREVIOUS,
    Keycode::QK_LED_MATRIX_BRIGHTNESS_UP,
    Keycode::QK_LED_MATRIX_BRIGHTNESS_DOWN,
    Keycode::QK_LED_MATRIX_SPEED_UP,
    Keycode::QK_LED_MATRIX_SPEED_DOWN,
    Keycode::QK_RGB_MATRIX_ON,
    Keycode::QK_RGB_MATRIX_OFF,
    Keycode::QK_RGB_MATRIX_TOGGLE,
    Keycode::QK_RGB_MATRIX_MODE_NEXT,
    Keycode::QK_RGB_MATRIX_MODE_PREVIOUS,
    Keycode::QK_RGB_MATRIX_HUE_UP,
    Keycode::QK_RGB_MATRIX_HUE_DOWN,
    Keycode::QK_RGB_MATRIX_SATURATION_UP,
    Keycode::QK_RGB_MATRIX_SATURATION_DOWN,
    Keycode::QK_RGB_MATRIX_VALUE_UP,
    Keycode::QK_RGB_MATRIX_VALUE_DOWN,
    Keycode::QK_RGB_MATRIX_SPEED_UP,
    Keycode::QK_RGB_MATRIX_SPEED_DOWN,
];

pub static AUDIO_KEYCODES: &[Keycode] = &[
    Keycode::QK_MIDI_ON,
    Keycode::QK_MIDI_OFF,
    Keycode::QK_MIDI_TOGGLE,
    Keycode::QK_MIDI_NOTE_C_0,
    Keycode::QK_MIDI_NOTE_C_SHARP_0,
    Keycode::QK_MIDI_NOTE_D_0,
    Keycode::QK_MIDI_NOTE_D_SHARP_0,
    Keycode::QK_MIDI_NOTE_E_0,
    Keycode::QK_MIDI_NOTE_F_0,
    Keycode::QK_MIDI_NOTE_F_SHARP_0,
    Keycode::QK_MIDI_NOTE_G_0,
    Keycode::QK_MIDI_NOTE_G_SHARP_0,
    Keycode::QK_MIDI_NOTE_A_0,
    Keycode::QK_MIDI_NOTE_A_SHARP_0,
    Keycode::QK_MIDI_NOTE_B_0,
    Keycode::QK_MIDI_NOTE_C_1,
    Keycode::QK_MIDI_NOTE_C_SHARP_1,
    Keycode::QK_MIDI_NOTE_D_1,
    Keycode::QK_MIDI_NOTE_D_SHARP_1,
    Keycode::QK_MIDI_NOTE_E_1,
    Keycode::QK_MIDI_NOTE_F_1,
    Keycode::QK_MIDI_NOTE_F_SHARP_1,
    Keycode::QK_MIDI_NOTE_G_1,
    Keycode::QK_MIDI_NOTE_G_SHARP_1,
    Keycode::QK_MIDI_NOTE_A_1,
    Keycode::QK_MIDI_NOTE_A_SHARP_1,
    Keycode::QK_MIDI_NOTE_B_1,
    Keycode::QK_MIDI_NOTE_C_2,
    Keycode::QK_MIDI_NOTE_C_SHARP_2,
    Keycode::QK_MIDI_NOTE_D_2,
    Keycode::QK_MIDI_NOTE_D_SHARP_2,
    Keycode::QK_MIDI_NOTE_E_2,
    Keycode::QK_MIDI_NOTE_F_2,
    Keycode::QK_MIDI_NOTE_F_SHARP_2,
    Keycode::QK_MIDI_NOTE_G_2,
    Keycode::QK_MIDI_NOTE_G_SHARP_2,
    Keycode::QK_MIDI_NOTE_A_2,
    Keycode::QK_MIDI_NOTE_A_SHARP_2,
    Keycode::QK_MIDI_NOTE_B_2,
    Keycode::QK_MIDI_NOTE_C_3,
    Keycode::QK_MIDI_NOTE_C_SHARP_3,
    Keycode::QK_MIDI_NOTE_D_3,
    Keycode::QK_MIDI_NOTE_D_SHARP_3,
    Keycode::QK_MIDI_NOTE_E_3,
    Keycode::QK_MIDI_NOTE_F_3,
    Keycode::QK_MIDI_NOTE_F_SHARP_3,
    Keycode::QK_MIDI_NOTE_G_3,
    Keycode::QK_MIDI_NOTE_G_SHARP_3,
    Keycode::QK_MIDI_NOTE_A_3,
    Keycode::QK_MIDI_NOTE_A_SHARP_3,
    Keycode::QK_MIDI_NOTE_B_3,
    Keycode::QK_MIDI_NOTE_C_4,
    Keycode::QK_MIDI_NOTE_C_SHARP_4,
    Keycode::QK_MIDI_NOTE_D_4,
    Keycode::QK_MIDI_NOTE_D_SHARP_4,
    Keycode::QK_MIDI_NOTE_E_4,
    Keycode::QK_MIDI_NOTE_F_4,
    Keycode::QK_MIDI_NOTE_F_SHARP_4,
    Keycode::QK_MIDI_NOTE_G_4,
    Keycode::QK_MIDI_NOTE_G_SHARP_4,
    Keycode::QK_MIDI_NOTE_A_4,
    Keycode::QK_MIDI_NOTE_A_SHARP_4,
    Keycode::QK_MIDI_NOTE_B_4,
    Keycode::QK_MIDI_NOTE_C_5,
    Keycode::QK_MIDI_NOTE_C_SHARP_5,
    Keycode::QK_MIDI_NOTE_D_5,
    Keycode::QK_MIDI_NOTE_D_SHARP_5,
    Keycode::QK_MIDI_NOTE_E_5,
    Keycode::QK_MIDI_NOTE_F_5,
    Keycode::QK_MIDI_NOTE_F_SHARP_5,
    Keycode::QK_MIDI_NOTE_G_5,
    Keycode::QK_MIDI_NOTE_G_SHARP_5,
    Keycode::QK_MIDI_NOTE_A_5,
    Keycode::QK_MIDI_NOTE_A_SHARP_5,
    Keycode::QK_MIDI_NOTE_B_5,
    Keycode::QK_MIDI_OCTAVE_N2,
    Keycode::QK_MIDI_OCTAVE_N1,
    Keycode::QK_MIDI_OCTAVE_0,
    Keycode::QK_MIDI_OCTAVE_1,
    Keycode::QK_MIDI_OCTAVE_2,
    Keycode::QK_MIDI_OCTAVE_3,
    Keycode::QK_MIDI_OCTAVE_4,
    Keycode::QK_MIDI_OCTAVE_5,
    Keycode::QK_MIDI_OCTAVE_6,
    Keycode::QK_MIDI_OCTAVE_7,
    Keycode::QK_MIDI_OCTAVE_DOWN,
    Keycode::QK_MIDI_OCTAVE_UP,
    Keycode::QK_MIDI_TRANSPOSE_N6,
    Keycode::QK_MIDI_TRANSPOSE_N5,
    Keycode::QK_MIDI_TRANSPOSE_N4,
    Keycode::QK_MIDI_TRANSPOSE_N3,
    Keycode::QK_MIDI_TRANSPOSE_N2,
    Keycode::QK_MIDI_TRANSPOSE_N1,
    Keycode::QK_MIDI_TRANSPOSE_0,
    Keycode::QK_MIDI_TRANSPOSE_1,
    Keycode::QK_MIDI_TRANSPOSE_2,
    Keycode::QK_MIDI_TRANSPOSE_3,
    Keycode::QK_MIDI_TRANSPOSE_4,
    Keycode::QK_MIDI_TRANSPOSE_5,
    Keycode::QK_MIDI_TRANSPOSE_6,
    Keycode::QK_MIDI_TRANSPOSE_DOWN,
    Keycode::QK_MIDI_TRANSPOSE_UP,
    Keycode::QK_MIDI_VELOCITY_0,
    Keycode::QK_MIDI_VELOCITY_1,
    Keycode::QK_MIDI_VELOCITY_2,
    Keycode::QK_MIDI_VELOCITY_3,
    Keycode::QK_MIDI_VELOCITY_4,
    Keycode::QK_MIDI_VELOCITY_5,
    Keycode::QK_MIDI_VELOCITY_6,
    Keycode::QK_MIDI_VELOCITY_7,
    Keycode::QK_MIDI_VELOCITY_8,
    Keycode::QK_MIDI_VELOCITY_9,
    Keycode::QK_MIDI_VELOCITY_10,
    Keycode::QK_MIDI_VELOCITY_DOWN,
    Keycode::QK_MIDI_VELOCITY_UP,
    Keycode::QK_MIDI_CHANNEL_1,
    Keycode::QK_MIDI_CHANNEL_2,
    Keycode::QK_MIDI_CHANNEL_3,
    Keycode::QK_MIDI_CHANNEL_4,
    Keycode::QK_MIDI_CHANNEL_5,
    Keycode::QK_MIDI_CHANNEL_6,
    Keycode::QK_MIDI_CHANNEL_7,
    Keycode::QK_MIDI_CHANNEL_8,
    Keycode::QK_MIDI_CHANNEL_9,
    Keycode::QK_MIDI_CHANNEL_10,
    Keycode::QK_MIDI_CHANNEL_11,
    Keycode::QK_MIDI_CHANNEL_12,
    Keycode::QK_MIDI_CHANNEL_13,
    Keycode::QK_MIDI_CHANNEL_14,
    Keycode::QK_MIDI_CHANNEL_15,
    Keycode::QK_MIDI_CHANNEL_16,
    Keycode::QK_MIDI_CHANNEL_DOWN,
    Keycode::QK_MIDI_CHANNEL_UP,
    Keycode::QK_MIDI_ALL_NOTES_OFF,
    Keycode::QK_MIDI_SUSTAIN,
    Keycode::QK_MIDI_PORTAMENTO,
    Keycode::QK_MIDI_SOSTENUTO,
    Keycode::QK_MIDI_SOFT,
    Keycode::QK_MIDI_LEGATO,
    Keycode::QK_MIDI_MODULATION,
    Keycode::QK_MIDI_MODULATION_SPEED_DOWN,
    Keycode::QK_MIDI_MODULATION_SPEED_UP,
    Keycode::QK_MIDI_PITCH_BEND_DOWN,
    Keycode::QK_MIDI_PITCH_BEND_UP,
    Keycode::QK_SEQUENCER_ON,
    Keycode::QK_SEQUENCER_OFF,
    Keycode::QK_SEQUENCER_TOGGLE,
    Keycode::QK_SEQUENCER_TEMPO_DOWN,
    Keycode::QK_SEQUENCER_TEMPO_UP,
    Keycode::QK_SEQUENCER_RESOLUTION_DOWN,
    Keycode::QK_SEQUENCER_RESOLUTION_UP,
    Keycode::QK_SEQUENCER_STEPS_ALL,
    Keycode::QK_SEQUENCER_STEPS_CLEAR,
    Keycode::QK_AUDIO_ON,
    Keycode::QK_AUDIO_OFF,
    Keycode::QK_AUDIO_TOGGLE,
    Keycode::QK_AUDIO_CLICKY_TOGGLE,
    Keycode::QK_AUDIO_CLICKY_ON,
    Keycode::QK_AUDIO_CLICKY_OFF,
    Keycode::QK_AUDIO_CLICKY_UP,
    Keycode::QK_AUDIO_CLICKY_DOWN,
    Keycode::QK_AUDIO_CLICKY_RESET,
    Keycode::QK_MUSIC_ON,
    Keycode::QK_MUSIC_OFF,
    Keycode::QK_MUSIC_TOGGLE,
    Keycode::QK_MUSIC_MODE_NEXT,
    Keycode::QK_AUDIO_VOICE_NEXT,
    Keycode::QK_AUDIO_VOICE_PREVIOUS,
];

pub static CUSTOM_KEYCODES: &[Keycode] = &[
    Keycode::QK_MACRO_0,
    Keycode::QK_MACRO_1,
    Keycode::QK_MACRO_2,
    Keycode::QK_MACRO_3,
